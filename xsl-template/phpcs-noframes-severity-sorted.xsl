...
<!--                                                                                -->
<!-- With some PHPCS specific changes by Juliette Reinders Folmer.                  -->
<!-- Changes:                                                                       -->
<!--  * Colour coding of errors/warnings                                            -->
<!--  * Addition of error source column                                             -->
<!--  * Addition of error column information                                        -->
...
<xsl:template match="checkstyle">
  ...
  <xsl:template match="file">
	...
	<xsl:variable name="class" select="@severity" />
      <tr>
        <xsl:call-template name="alternated-row"/>
        <td class="{$class}"><xsl:value-of select="@severity"/></td>
        <td><xsl:value-of select="@message"/></td>
        <td class="{$class}"><xsl:value-of select="@source"/></td>
